...
import { Video, Mail, Lock, ArrowRight, Github, Chrome } from 'lucide-react';
    ...
    <div className="min-h-screen flex bg-white">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-900 relative overflow-hidden items-center justify-center p-12">
        ...
        <div className="relative z-10 max-w-lg text-white">
          ...
          <h2 className="text-4xl font-bold mb-6">Connect with your team, anywhere.</h2>
          <p className="text-lg text-indigo-100 leading-relaxed mb-8">
            "Lumina has completely transformed how we handle remote meetings. The AI features are a game changer."
          </p>
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-indigo-200">Engineering Manager at TechCorp</p>
            </div>
          </div>
        </div>
      </div>
